  ...
  describe "PATCH #update" do
    context "valid attributes" do
      it "updates an artist" do
        artist = create(:artist)
        patch :update, {:id => artist.to_param, :artist => attributes_for(:artist, name: "new name")}
        artist.reload
      ...
      it "redirects to newly updated artist" do
        artist = create(:artist)
        patch :update, {:id => artist.to_param, :artist => attributes_for(:artist, name: "new name")}
        artist.reload
    ...
    context "invalid attributes" do
      it "assigns the requested artist as @artist" do
        artist = create(:artist)
        patch :update, {:id => artist.to_param, :artist => attributes_for(:artist, name: nil)}
        expect(assigns(:artist)).to eq(artist)
      end
